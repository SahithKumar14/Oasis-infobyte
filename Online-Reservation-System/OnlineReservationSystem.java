...
public class OnlineReservationSystem {
    ...
    public void run() {
        ...
        while (true) {
            System.out.println("------------------------------------------------");
            System.out.println("----- WELCOME TO EASY GO ONLINE RESERVATION SYSTEM -----");
            System.out.println("------------------------------------------------");
    ...
    private void login(Scanner sc) {
        ...
        if (users.containsKey(username) && users.get(username).equals(password)) {
            ...
            System.out.println("\n" + "Invalid username or password... Please provide correct details...");
        }
    }
    ...
    public static void main(String[] args) {
        OnlineReservationSystem registrationSystem = new OnlineReservationSystem();
